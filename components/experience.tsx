        ...
        <div className="grid md:grid-cols-2 gap-16">
          ...
          <div>
            <div className="flex items-center gap-2 mb-8">
              ...
              <h3 className="text-sm font-semibold text-[#a1a1aa] uppercase tracking-wider">Work</h3>
            </div>
                ...
                >
                  ...
                  <div>
                    <div className="flex items-start justify-between mb-0.5">
                      ...
                      {exp.current && (
                        <span className="text-[10px] font-mono px-2 py-0.5 rounded border border-[#3b82f6]/40 text-[#3b82f6] shrink-0 ml-2">
                          now
                        </span>
                      )}
                    </div>
          ...
          <div>
            <div className="flex items-center gap-2 mb-8">
              ...
              <h3 className="text-sm font-semibold text-[#a1a1aa] uppercase tracking-wider">Education</h3>
            </div>
            <div className="relative pl-6 space-y-8">
              <div className="absolute left-[7px] top-0 bottom-0 w-px bg-[#27272a]" />
              {education.map((edu, i) => (
